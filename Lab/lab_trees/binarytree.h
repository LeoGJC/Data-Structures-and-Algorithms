...
class BinaryTree
{
    public:
        ...
        void isOrderedRecursive(Node* subRoot, vector<T> &array) const;
        ...
        void getPaths(const Node* node, vector<vector<T> > &paths, vector<T> array) const;
        ...
        int sumDistances(Node *subRoot, unsigned longitude) const;
